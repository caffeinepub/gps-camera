...
export class Backend implements backendInterface {
    ...
    async addPhoto(arg0: string, arg1: number, arg2: number, arg3: string | null, arg4: ExternalBlob): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addPhoto(arg0, arg1, arg2, to_candid_opt_n8(this._uploadFile, this._downloadFile, arg3), await to_candid_ExternalBlob_n9(this._uploadFile, this._downloadFile, arg4));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getPhotosInRange(arg0: number, arg1: number, arg2: number, arg3: number): Promise<Array<Photo>> {
        if (this.processError) {
            try {
                const result = await this.actor.getPhotosInRange(arg0, arg1, arg2, arg3);
                return from_candid_vec_n10(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
